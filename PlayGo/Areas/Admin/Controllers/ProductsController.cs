...
using PlayGo.Areas.Admin.Models.ViewModels;
...
namespace PlayGo.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IProductRepository productRepo, IMapper mapper, ICategoryRepository categoryRepo, IWebHostEnvironment webHostEnvironment)
        {
